...
# @lat: [[evaluation#Evaluation and Verification#Screening Median Text Timing Noise Sweep#Condition Execution]]
def main() -> None:
    ...
    if socket.gethostname() != "baekryun-cuda129":
        raise ValueError("text screening-median conditions require baekryun")
    expected_samples = (

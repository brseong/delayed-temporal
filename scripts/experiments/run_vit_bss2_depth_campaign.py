...
# @lat: [[evaluation#Evaluation and Verification#ViT-B Cumulative Encoder Block Timing Noise#Campaign Protocol]]
def main() -> None:
    ...
    if socket.gethostname() != "baekryun-cuda129":
        raise ValueError("depth campaign supervisor must run on baekryun")
    if (
        not args.gpus

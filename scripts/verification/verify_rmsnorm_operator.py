...
# @lat: [[rmsnorm#RMSNorm Operator Composition#Verification#Algebra and Finite Domains]]
...
# @lat: [[rmsnorm#RMSNorm Operator Composition#Verification#Shared Events and Noise]]
...
# @lat: [[rmsnorm#RMSNorm Operator Composition#Verification#Clock and Invalid Inputs]]
...
# @lat: [[rmsnorm#RMSNorm Operator Composition#Verification#Pretrained Llama Parameters]]
...
# @lat: [[rmsnorm#RMSNorm Operator Composition#Rigorous Audit#Complete Event Readout]]
...
# @lat: [[rmsnorm#RMSNorm Operator Composition#Rigorous Audit#Floor and Input Masks]]
...
# @lat: [[rmsnorm#RMSNorm Operator Composition#Rigorous Audit#Numerical Precision and Bounds]]
...
# @lat: [[rmsnorm#RMSNorm Operator Composition#Rigorous Audit#Shape and Model Coverage]]

...
On 2026-09-15, cached BERT, RoBERTa, and GPT-2 checkpoints completed a short policy-1 smoke check under the now-removed shared-range contract. Its logs remain provenance only; current evaluation rejects those tables and recollects the complete local-range site set.
